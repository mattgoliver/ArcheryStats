...
#totalArrowsShot, totalAverageFlightScore, totalIndividualScore = allTimeResults(retrieveData())
#print("totalArrowsShot: "+str(totalArrowsShot)+", totalAverageFlightScore: "+str(totalAverageFlightScore)+", totalIndividualScore: "+str(totalIndividualScore))
# saveData()
...
#totalArrowsShot, totalAverageFlightScore, totalIndividualScore = allTimeResults(retrieveData())
#print(totalIndividualScore)
#pieGraphScores(totalIndividualScore, title="All Available Data", show=True, save=False)
...
deleteData = QtWidgets.QPushButton(centralwidget)
deleteData.setGeometry(QtCore.QRect(310, 200, 141, 41))
deleteData.setObjectName("deleteData")
deleteData.clicked.connect(lambda: guiDeleteSelectedData())
...
#outputText.setText("No Output Generated")
...
deleteData.setText(_translate("MainWindow", "Delete Selected Data"))
